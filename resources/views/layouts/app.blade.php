...
<html lang="en">
    <head>
        ...
        <title>@yield('titulo','proyecto_Mr._Jeans_Tienda')</title>
        ...
        <body>
            <header>
                ...
                <div class="text-end texto-sm text-green-400 mx-4">
                    Bienvenido {{ $nombre }}!
                </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        @foreach ($mercancias as $mercancia)
                <div class="card w-46 bg-base-500 shadow-xl">
        ...
        @endforeach
                ...
                <main>
                    ...
                    <footer class="footer items-center p-1 bg-neutral text-neutral-content">
                        <aside class="items-center grid-flow-cols">
                            ...
                            <p>Mr. Jeans Tienda Copyright © 2024 - All right reserved </p>
                        </aside> 
                            <nav class="grid-flow-cols gap-0 md:place-self-center md:justify-self-end">
